...
<!-- 
    ...
    Rotten Tomatoes := Calificación Rotten Tomatoes
    
    Nos interesa obtener una sola calificación por lo que sacaremos un calificación promedio de ambas
-->
...
datos <- add_column(datos, 
                   Calificacion = rowMeans(datos[,c("IMDb", "Rotten Tomatoes")], na.rm=TRUE), 
